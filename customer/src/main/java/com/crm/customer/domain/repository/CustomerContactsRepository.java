...
import com.crm.customer.domain.model.CustomerContactsEntity;
...
@Repository
public interface CustomerContactsRepository extends CustomerBaseRepository<CustomerContactsEntity, Long> {
